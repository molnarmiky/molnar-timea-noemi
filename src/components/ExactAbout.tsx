...
import aboutImage from 'figma:asset/5782395dbf795dc95dc05bc5e8a36d90dff70939.png';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex justify-center lg:justify-start order-2 lg:order-1">
            <div className="w-72 h-80 sm:w-80 sm:h-96 rounded-2xl overflow-hidden border-4 border-[#a594f9]/30 shadow-2xl">
              <img
                src={aboutImage}
                alt="Sesiune de consiliere psihologică - Psiholog și client în cabinet profesional"
