...
export function BlogManager() {
  ...
  const handleSave = () => {
    if (isCreating) {
      addBlogPost(editForm as Omit<BlogPost, 'id' | 'createdAt' | 'updatedAt'>);
      setIsCreating(false);
  ...
  const categories = [
    'Anxietate', 'Relații', 'Mindfulness', 'Dezvoltare Personală', 
    'Comunicare', 'Sănătate Mentală', 'Parenting', 'Stress'
  ];
